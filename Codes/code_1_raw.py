...
elektrik = df['elektrik enerjisi']
features = df.drop('elektrik enerjisi', axis = 1)
...
d = {'K-Fold': ['mse-mean', 'r2-mean'], 'LR': lr_list, 'RIDGE': ridge_list, 'LASSO': lasso_list,
